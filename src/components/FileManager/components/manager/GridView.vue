<template>
    <div class="fm-grid">
        <div class="d-flex align-content-start flex-wrap">
            <div v-if="!isRootPath" @click="levelUp" class="fm-grid-item text-center">
            ...
            <div class="fm-grid-item text-center unselectable"
                ...
                <div class="fm-item-icon">
                    <i class="fa-5x pb-2"
                       :class="(acl && directory.acl === 0) ? 'fas fa-unlock-alt' : 'far fa-folder'"></i>
                </div>
            ...
            <div class="fm-grid-item text-center unselectable"
                ...
                <div class="fm-item-icon">
                    ...
                    <i v-else class="far fa-5x pb-2"
                       :class="extensionToIcon(file.extension)"></i>
                </div>
