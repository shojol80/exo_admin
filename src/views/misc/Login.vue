                    ...
                    <b-form>
                        <b-input-group class="mb-3" size="lg">
                            <b-input-group-prepend>
                                <b-input-group-text>
                                    <icon :icon="$icons.user" class="fa-fw"></icon>
                                </b-input-group-text>
                            </b-input-group-prepend>
                        ...
                        <b-input-group class="mb-3" size="lg">
                            ...
                            <b-form-invalid-feedback id="inputLiveFeedback" class="order-last" v-if="error"
                                                     style="display: block">
                        ...
                        <b-row>
                            <b-col class="d-flex justify-content-between">
                                ...
                                <b-button variant="success"
                                          size="lg"
                                          class="btn-min"
                                          v-on:click="login">🎯 Sign In (UPDATED)
                                </b-button>
                            </b-col>
                        </b-row>
                    </b-form>
                    ...
                    <b-form @submit.prevent="">
                        <div class="mb-4">
                            <input-two-factor-auth-code
                                ...
                                ref="inputCode" v-model="gaCode" :error="error"
                                @enter="login">
                            </input-two-factor-auth-code>
...
export default {
    ...
    mounted() {
        if (this.$route.params.redir) {
            this.$store.dispatch('auth/saveRouteBeforeAuth', this.$route.params.redir)
        }
    ...
    methods: {
        async login() {
            ...
            await this.$store.dispatch('auth/request', {u_email, u_password, gaCode, remember})
        ...
        resetPassword() {
            const {u_email} = this
            this.$store.dispatch('auth/SendPasswordLink', u_email)
                .then(() => {
                    this.state = 'LOGIN'
        ...
        lostCode() {
            this.$awn.info('Please contact with administrator. <a href="mailto:info@exolog.nl?subject=Dealer two step verification">info@exolog.nl</a>')
        },
        goBack() {
            this.state = 'LOGIN'
            this.gaCode = '';
