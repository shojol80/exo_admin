        ...
        <b-card>
          ...
          <b-form-group>
            <b-input-group>
              ...
              <b-input-group-append><b-input-group-text><i class="envelope-o"></i></b-input-group-text></b-input-group-append>
            </b-input-group>
          </b-form-group>
          <b-form-group>
            <b-input-group>
          ...
          <b-form>
            ...
            <b-form-group>
              <b-input-group>
                ...
                <b-input-group-append><b-input-group-text><i class="envelope"></i></b-input-group-text></b-input-group-append>
              </b-input-group>
            </b-form-group>
            <b-form-group>
              <b-input-group>
        ...
        <b-card>
          ...
          <b-form>
            ...
            <b-form-group>
              <b-input-group>
                <b-input-group-prepend>
                  <b-input-group-text><i class="envelope"></i></b-input-group-text>
                </b-input-group-prepend>
                <b-form-input type="email" placeholder="Email" autocomplete="email"></b-form-input>
              </b-input-group>
            </b-form-group>
