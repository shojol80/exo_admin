        ...
        <b-row>
            <b-col xs="12" md="6">
                <b-card>
                    ...
                    <c-switch class="mx-1" color="primary" checked name="switch1" v-model="checker" value="yes"
                              uncheckedValue="no"/>
            ...
            <b-col md="12">
                <b-card no-body>
                    ...
                    <b-card-body class="p-0">
                        <b-table hover striped responsive="sm" class="table-align-middle mb-0" :items="items"
                                 :fields="fields">
                            <template slot="example" slot-scope="data">
                                <c-switch :variant="data.value.variant" :color="data.value.color"
                                          :size="data.value.size" :checked="data.value.checked"/>
                            </template>
